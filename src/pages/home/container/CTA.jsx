...
const CTA = () => {
  return (
    <>
      ...
      <section className="relative bg-fourth px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              <input
                type="text"
                className="px-4 py-3 rounded-lg w-full placeholder:text-black"
                placeholder="Your Email"
              />
              <button className="px-4 py-3 rounded-lg w-full bg-third text-white font-bold md:w-fit md:whitespace-nowrap">
                Get started
              </button>
            </div>
            <p className="text-first text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              <span className="font-bold italic text-[#e4e5e9] md:not-italic md:font-normal md:text-dark-light">
                Get a response tomorrow if you submit by 9pm today.
              </span>{" "}
               If we received after 9pm will get a
